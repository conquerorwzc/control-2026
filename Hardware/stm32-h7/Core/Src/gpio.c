...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : POWER_24V_L_Pin POWER_24V_R_Pin POWER_5V_Pin ACC_CS_Pin
                           GYRO_CS_Pin */
  GPIO_InitStruct.Pin = POWER_24V_L_Pin|POWER_24V_R_Pin|POWER_5V_Pin|ACC_CS_Pin
                          |GYRO_CS_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /*Configure GPIO pin : Micro_switch_Pin_Pin */
  GPIO_InitStruct.Pin = Micro_switch_Pin_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(Micro_switch_Pin_GPIO_Port, &GPIO_InitStruct);
