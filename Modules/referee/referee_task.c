...
static void MyUIRefresh(Referee_Interactive_info_t *interactive_data)
{
    ...
    UIRectangleDraw(&UI_lift_bar_chassis_fg, "lbf", UI_Graph_Change, 7, UI_Color_Cyan, 6, 1705, 610, 1730, chs_top_y);
    ...
    for (int i = 0; i < 5; i++)
    {
        ...
        UICharDraw(&UI_motor_angle_value[i], graph_name, UI_Graph_Change, 7, UI_Color_Green, 16, 2, 1200 + i * 120, 830,
                   angle_buf);
    ...
    for (int i = 0; i < 5; i++)
    {
        ...
        UICharDraw(&UI_arm_angle_value[i], graph_name, UI_Graph_Change, 7, UI_Color_Cyan, 16, 2, 1200 + i * 120, 800,
                   angle_buf);
