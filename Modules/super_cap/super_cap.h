...
// 超级电容策略结构体
typedef enum {
  SUPER_CAP_SAFETY_MODE = 0,  // 安全模式
  SUPER_CAP_PASSIVE_MODE,     // 被动模式
  SUPER_CAP_ACTIVE_MODE,      // 主动模式
  SUPER_CAP_CHARGING_MODE,    // 充电模式
} SuperCap_Mode_e;

typedef enum {
  SUPER_CAP_NORMAL = 0,  // 正常模式，不使用超电能量
  SUPER_CAP_BOOST = 1,   // 超电模式，主动使用超电能量
} SuperCap_Ctrl_Cmd_e;
