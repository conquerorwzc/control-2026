...
void CustomControllerTask(CustomController_t* controller)
{
    ...
    if (controller->motors[2].dji_motor != NULL) {
        controller->motor_angles[2] = controller->motors[2].dji_motor->measure.total_angle;
    }
    if (controller->motors[3].dji_motor != NULL) {
        controller->motor_angles[3] = controller->motors[3].dji_motor->measure.total_angle;
    }
