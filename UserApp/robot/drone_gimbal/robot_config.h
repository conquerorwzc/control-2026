...
#define PITCH_MAX_ANGLE 3.0f   // 云台竖直方向最大角度 (注意反馈如果是陀螺仪，则填写陀螺仪的角度)
#define PITCH_MIN_ANGLE -28.0f  // 云台竖直方向最小角度 (注意反馈如果是陀螺仪，则填写陀螺仪的角度)

#define YAW_MAX_ANGLE 25.0f   // 云台竖直方向最大角度 (注意反馈如果是陀螺仪，则填写陀螺仪的角度)
#define YAW_MIN_ANGLE -25.0f  // 云台竖直方向最小角度 (注意反馈如果是陀螺仪，则填写陀螺仪的角度)
...
static Shoot_Init_Config_s shoot_init_config = {
    ...
    .friction_motor_config[1] = FRICTION_MOTOR_CONFIG(&hcan1, 2, MOTOR_DIRECTION_REVERSE),
