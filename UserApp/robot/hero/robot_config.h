...
// 机器人底盘修改的参数,单位为mm(毫米)
#define WHEEL_BASE 140               // 纵向轴距(前进后退方向)
#define TRACK_WIDTH 160              // 横向轮距(左右平移方向)
...
#define PITCH_MAX_ANGLE 9.4f    // 云台竖直方向最大角度 (注意反馈如果是陀螺仪，则填写陀螺仪的角度)
#define PITCH_MIN_ANGLE -19.7f  // 云台竖直方向最小角度 (注意反馈如果是陀螺仪，则填写陀螺仪的角度)
// 私有宏,自动将编码器转换成角度值
...
#define REDUCTION_RATIO_LOADER 100.0f  // 2006拨盘电机的减速比,英雄需要修改为3508的19.0f
