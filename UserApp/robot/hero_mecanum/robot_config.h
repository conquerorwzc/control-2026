...
static Shoot_Init_Config_s shoot_init_config = {
    ...
    .friction_motor_config[1] = FRICTION_MOTOR_CONFIG(&hcan2, 4, MOTOR_DIRECTION_REVERSE),
    .friction_motor_config[2] = FRICTION_MOTOR_CONFIG(&hcan2, 2, MOTOR_DIRECTION_NORMAL),
