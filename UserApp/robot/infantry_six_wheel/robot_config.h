...
// 云台参数
#define YAW_CHASSIS_ALIGN_ECD 5029  // 云台和底盘对齐指向相同方向时的电机编码器值,若对云台有机械改动需要修改
...
static Chassis_Init_Config_s chassis_init_config = {
    ...
    .wheel_motor_config[1] = WHEEL_MOTOR_CONFIG(&hcan1, 2),
    .joint_motor_config[0] = JOINT_MOTOR_CONFIG(MOTOR_DIRECTION_NORMAL, MOTOR_DIRECTION_REVERSE, &hcan2, 0x02, 0x01),
    .joint_motor_config[1] = JOINT_MOTOR_CONFIG(MOTOR_DIRECTION_NORMAL, MOTOR_DIRECTION_REVERSE, &hcan2, 0x06, 0x03),
    .joint_motor_config[2] = JOINT_MOTOR_CONFIG(MOTOR_DIRECTION_REVERSE, MOTOR_DIRECTION_NORMAL, &hcan2, 0x08, 0x04),
    .joint_motor_config[3] = JOINT_MOTOR_CONFIG(MOTOR_DIRECTION_REVERSE, MOTOR_DIRECTION_NORMAL, &hcan2, 0x0A, 0x05),
