...
#define LEG_INIT_CONFIG(joint_motor_reverse, wheel_motor_reverse, joint_can_0, joint_tx_0, joint_rx_0, joint_can_1, \
  ...
  {                                                                                                                 \
      ...
      .LQR_K_Coefficient = {{{-84.54320234394912f, 185.708665980343f, -169.8934054094552f, 1.237427484915304f},     \
                             {78.78108062473079f, -310.9087152906694f, 359.0521089724583f, 0.3880080261650199f},    \
                             {-9.943922595869035f, 15.58583656479198f, -15.39099172271206f, 0.3027439375489276f},   \
                             {12.18512821000114f, -45.25774654160243f, 51.33715399090994f, 0.1205432962522759f},    \
                             {-18.44781461730912f, 49.67262903377532f, -48.48831939967344f, 0.5876130208452064f},   \
                             {15.98996412545369f, -76.01553671128869f, 94.24897470172604f, 0.9732670343515304f}},   \
                            {{-19.58686346016774f, 52.49813441843957f, -52.1762499019097f, 0.44871201455199f},      \
                             {14.73049846562381f, -74.76684384061238f, 94.6217317167807f, 1.395778721764284f},      \
                             {-21.73412947152635f, 16.85867662660569f, 5.619749289240847f, 8.200343229016035f},     \
                             {57.32529896226958f, -132.1448572704325f, 111.5090290624125f, 7.366321232978446f},     \
                             {-2.703262265828413f, 1.836668163303944f, 0.910540448628463f, 1.176621737693498f},     \
                             {4.076163596897428f, -5.926080063974089f, 2.081310330137294f, 0.979111465738212f}}},   \
      .length_PID_config =                                                                                          \
          {                                                                                                         \
              .Kp = 350.0f,                                                                                         \
              .Ki = 0.0f,                                                                                           \
