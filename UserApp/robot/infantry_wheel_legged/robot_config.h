...
#define LEG_INIT_CONFIG(joint_motor_reverse, wheel_motor_reverse, joint_can_0, joint_tx_0, joint_rx_0, joint_can_1, \
  ...
  {                                                                                                                 \
      ...
      .LQR_K_Coefficient =                                                                                          \
          {{{4.415511839983614e+2f, -3.171006940100889e+2f, -5.328603550480479e+1f, 1.021471152251099f},            \
            {9.35746418306052e+1f, -8.870461838684862e+1f, -2.847610117691043f, 2.301471231002467e-1f},             \
            {1.124462850297074e+2f, -5.725751256638275e+1f, -2.485776322099811e+1f, 1.959436528880611f},            \
            {1.132445613142351e+2f, -6.259521094803299e+1f, -2.340989399880077e+1f, 1.284518773866269f},            \
            {-1.379161115602845e+2f, 2.259558292636835e+2f, -1.59077588007052e+2f, 5.629689351522718e+1f},          \
            {-1.954041619152623e+1f, 2.196722146649951e+1f, -1.12651499943364e+1f, 3.889648529770642f}},            \
           {{5.232284005553488f, -1.656632283964679e+2f, 1.274100024513172e+2f, -6.44184925503793f},                \
            {-1.922014190589402e+1f, -1.157185929956442e+1f, 2.093461744638756e+1f, -9.807483869096953e-1f},        \
            {5.170531073982538e+1f, -9.28306075109487e+1f, 4.496109115455196e+1f, -9.023597961709542e-1f},          \
            {6.033662401783558e+1f, -1.007415717805607e+2f, 4.838332226464492e+1f, -1.549590589536334f},            \
            {6.19991461394924e+2f, -6.981607077521169e+2f, 2.988218209694531e+2f, 6.145440637684433e+1f},           \
            {1.705734796960876e+1f, -2.061805939738924e+1f, 1.024809584118514e+1f, 4.627691770872311f}}},           \
      .length_PID_config =                                                                                          \
          {                                                                                                         \
              .Kp = 350.0f,                                                                                         \
              .Ki = 0.0f,                                                                                           \
