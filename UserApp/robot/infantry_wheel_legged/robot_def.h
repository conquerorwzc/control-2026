...
/* 底盘类型定义,烧录时注意不要弄错对应功能;修改定义后需要重新编译,只能存在一个定义! */
#define CHASSIS_MECANUM_WHEEL
// #define CHASSIS_OMNI_WHEEL
// #define CHASSIS_STEER_WHEEL
// #define CHASSIS_WHEEL_LEGGED

#define VISION_USE_VCP  // 使用虚拟串口发送视觉数据
// #define VISION_USE_UART // 使用串口发送视觉数据

// 定义机器人类型
#define INFANTRY_WHEEL_LEGGED
