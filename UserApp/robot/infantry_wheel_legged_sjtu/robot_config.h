        ...
        {.param =
             {
                 ...
                 .LQR_K_Coefficients =
                     {
                         {-25.008356f, 55.991134f, -13.208812f, -63.021890f, -48.554486f, 99.518521f},    // K[0][0]
                         {-22.865532f, 50.036047f, -5.105079f, -56.270751f, -44.032413f, 77.254300f},     // K[0][1]
                         {-4.080298f, -8.720077f, -65.631543f, 16.935121f, -44.527455f, 106.756690f},     // K[0][2]
                         {-0.701421f, -2.099800f, -17.265546f, 4.047215f, -10.641853f, 27.516656f},       // K[0][3]
                         {-14.137518f, 37.263329f, 55.816888f, -52.846072f, 51.316725f, -53.661445f},     // K[0][4]
                         {-0.041794f, -0.288332f, 1.246466f, -0.714141f, 2.644338f, -1.631086f},          // K[0][5]
                         {-13.844587f, 30.259983f, -126.679438f, -29.179118f, -69.137113f, 236.329034f},  // K[0][6]
                         {-3.211312f, 0.335140f, 4.464777f, -0.710422f, 0.537428f, -2.836203f},           // K[0][7]
                         {0.444302f, 3.775620f, 206.233647f, -1.638437f, -71.849438f, -180.687312f},      // K[0][8]
                         {-1.668413f, 3.796045f, 20.193390f, -3.287864f, -13.718694f, -12.562787f},       // K[0][9]
                         {-25.008356f, -13.208812f, 55.991134f, 99.518521f, -48.554486f, -63.021890f},    // K[1][0]
                         {-22.865532f, -5.105079f, 50.036047f, 77.254300f, -44.032413f, -56.270751f},     // K[1][1]
                         {4.080298f, 65.631543f, 8.720077f, -106.756690f, 44.527455f, -16.935121f},       // K[1][2]
                         {0.701421f, 17.265546f, 2.099800f, -27.516656f, 10.641853f, -4.047215f},         // K[1][3]
                         {-13.844587f, -126.679438f, 30.259983f, 236.329034f, -69.137113f, -29.179118f},  // K[1][4]
                         {-3.211312f, 4.464777f, 0.335140f, -2.836203f, 0.537428f, -0.710422f},           // K[1][5]
                         {-14.137518f, 55.816888f, 37.263329f, -53.661445f, 51.316725f, -52.846072f},     // K[1][6]
                         {-0.041794f, 1.246466f, -0.288332f, -1.631086f, 2.644338f, -0.714141f},          // K[1][7]
                         {0.444302f, 206.233647f, 3.775620f, -180.687312f, -71.849438f, -1.638437f},      // K[1][8]
                         {-1.668413f, 20.193390f, 3.796045f, -12.562787f, -13.718694f, -3.287864f},       // K[1][9]
                         {-0.024661f, -11.115385f, 35.791210f, 13.318874f, -0.233026f, -42.909748f},      // K[2][0]
                         {0.368707f, -9.428125f, 29.891569f, 11.726460f, 0.356399f, -35.990628f},         // K[2][1]
                         {-5.795234f, -10.485267f, 18.886969f, 11.739450f, 8.522348f, -13.655490f},       // K[2][2]
                         {-1.147924f, -2.599459f, 4.467701f, 2.692542f, 1.835547f, -2.649232f},           // K[2][3]
                         {1.453441f, 16.371896f, 6.715223f, -13.125003f, -9.856801f, -19.001772f},        // K[2][4]
                         {-0.051129f, 0.894787f, 0.166610f, 0.041627f, 0.167341f, -0.810198f},            // K[2][5]
                         {0.876562f, -13.951234f, 53.038148f, 17.022420f, -1.222476f, -38.016071f},       // K[2][6]
                         {0.183817f, 0.153095f, 2.523972f, -0.198853f, -0.274616f, -1.438532f},           // K[2][7]
                         {14.780979f, -26.579897f, -0.359290f, 25.836207f, 15.666566f, -31.339438f},      // K[2][8]
                         {1.984142f, -4.700462f, 0.507063f, 4.644793f, 3.031582f, -4.467752f},            // K[2][9]
                         {-0.024661f, 35.791210f, -11.115385f, -42.909748f, -0.233026f, 13.318874f},      // K[3][0]
                         {0.368707f, 29.891569f, -9.428125f, -35.990628f, 0.356399f, 11.726460f},         // K[3][1]
                         {5.795234f, -18.886969f, 10.485267f, 13.655490f, -8.522348f, -11.739450f},       // K[3][2]
                         {1.147924f, -4.467701f, 2.599459f, 2.649232f, -1.835547f, -2.692542f},           // K[3][3]
                         {0.876562f, 53.038148f, -13.951234f, -38.016071f, -1.222476f, 17.022420f},       // K[3][4]
                         {0.183817f, 2.523972f, 0.153095f, -1.438532f, -0.274616f, -0.198853f},           // K[3][5]
                         {1.453441f, 6.715223f, 16.371896f, -19.001772f, -9.856801f, -13.125003f},        // K[3][6]
                         {-0.051129f, 0.166610f, 0.894787f, -0.810198f, 0.167341f, 0.041627f},            // K[3][7]
                         {14.780979f, -0.359290f, -26.579897f, -31.339438f, 15.666566f, 25.836207f},      // K[3][8]
                         {1.984142f, 0.507063f, -4.700462f, -4.467752f, 3.031582f, 4.644793f}             // K[3][9]
                     },
             },
