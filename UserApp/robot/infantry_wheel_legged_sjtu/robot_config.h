...
#define R_W 0.25025f /* half track width (m) — SJTU */
#define ROBOT_MASS 14.0f
#define LEG_MAX_LENGTH 0.370f  // 0.380f
#define LEG_MIN_LENGTH 0.120f  // 0.112f
/* SJTU chassis model params (from plan) */
#define CHASSIS_M_B 16.7f
#define CHASSIS_I_B 0.3160f
#define CHASSIS_L_B 0.0f
#define CHASSIS_I_YAW 0.5965f
#define CHASSIS_M_W 0.7f
#define CHASSIS_M_LEG 1.3f
...
static Chassis_Init_Config_s chassis_init_config = {
    ...
    /* P0: 必须从 MATLAB 填入。在 Utils/Simulink/wheel_legged_sjtu 运行 linearize_system_v2.m 生成
     * linearized_system.mat，再运行 compute_lqr.m，将终端输出的 .K = { ... } 与 .LQR_K_Coefficients = { ... }
     * 粘贴到下方，替换全零占位。否则 LQR 无反馈，无法平衡与速度跟踪。 */
