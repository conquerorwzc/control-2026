            ...
            .param =
                {
                    ...
                    .LQR_K_Coefficients =
                        {
                            {-24.904661f, 68.212755f, 13.110731f, -71.544580f, -68.475007f, 57.169704f},  // K[0][0]
                            {-28.447863f, 79.963502f, 19.515129f, -80.980596f, -85.786808f, 57.443012f},  // K[0][1]
                            {-19.270392f, -68.883138f, -121.105775f, 102.828552f, -105.826562f,
                             215.961387f},                                                                 // K[0][2]
                            {-1.515965f, -7.858866f, -20.844273f, 11.759828f, -18.930698f, 35.192817f},    // K[0][3]
                            {-11.317881f, 56.501869f, 77.734939f, -77.393438f, 78.697193f, -109.212108f},  // K[0][4]
                            {-0.151425f, 0.586705f, 2.447710f, -1.106465f, 2.375245f, -4.037135f},         // K[0][5]
                            {-38.478199f, 18.026208f, -11.614692f, -11.739393f, -94.949188f, 96.491881f},  // K[0][6]
                            {-3.258412f, 0.437142f, 7.398998f, -0.758423f, -0.460550f, -6.975224f},        // K[0][7]
                            {65.425740f, -142.261713f, 858.592978f, 159.125503f, -170.030041f,
                             -1013.672966f},                                                                 // K[0][8]
                            {1.785383f, -4.885655f, 36.366644f, 6.057959f, -15.044090f, -35.125914f},        // K[0][9]
                            {-24.904661f, 13.110731f, 68.212755f, 57.169704f, -68.475007f, -71.544580f},     // K[1][0]
                            {-28.447863f, 19.515129f, 79.963502f, 57.443012f, -85.786808f, -80.980596f},     // K[1][1]
                            {19.270392f, 121.105775f, 68.883138f, -215.961387f, 105.826562f, -102.828552f},  // K[1][2]
                            {1.515965f, 20.844273f, 7.858866f, -35.192817f, 18.930698f, -11.759828f},        // K[1][3]
                            {-38.478199f, -11.614692f, 18.026208f, 96.491881f, -94.949188f, -11.739393f},    // K[1][4]
                            {-3.258412f, 7.398998f, 0.437142f, -6.975224f, -0.460550f, -0.758423f},          // K[1][5]
                            {-11.317881f, 77.734939f, 56.501869f, -109.212108f, 78.697193f, -77.393438f},    // K[1][6]
                            {-0.151425f, 2.447710f, 0.586705f, -4.037135f, 2.375245f, -1.106465f},           // K[1][7]
                            {65.425740f, 858.592978f, -142.261713f, -1013.672966f, -170.030041f,
                             159.125503f},                                                                   // K[1][8]
                            {1.785383f, 36.366644f, -4.885655f, -35.125914f, -15.044090f, 6.057959f},        // K[1][9]
                            {2.292562f, -13.725887f, 39.176330f, 18.844714f, -5.767832f, -49.476602f},       // K[2][0]
                            {3.046714f, -16.022194f, 40.592231f, 21.007157f, -2.714166f, -53.111488f},       // K[2][1]
                            {-20.161992f, -27.855422f, 64.660372f, 25.644058f, 48.544758f, -70.394035f},     // K[2][2]
                            {-2.089752f, -4.960993f, 8.114385f, 4.348208f, 6.383453f, -6.819777f},           // K[2][3]
                            {2.023175f, 32.850888f, -1.359266f, -19.203713f, -32.701484f, -13.368484f},      // K[2][4]
                            {-0.036885f, 1.540480f, -0.102255f, -0.134881f, -0.514582f, -0.642203f},         // K[2][5]
                            {5.084977f, -16.396744f, 78.126808f, 17.566893f, 2.850045f, -70.350085f},        // K[2][6]
                            {0.330801f, 0.122837f, 3.290680f, -0.228831f, -0.228374f, -2.537048f},           // K[2][7]
                            {72.184449f, -109.826156f, -131.450631f, 106.769572f, 118.460333f, 25.030999f},  // K[2][8]
                            {4.342461f, -8.708921f, -4.621033f, 8.282228f, 7.879481f, -2.134527f},           // K[2][9]
                            {2.292562f, 39.176330f, -13.725887f, -49.476602f, -5.767832f, 18.844714f},       // K[3][0]
                            {3.046714f, 40.592231f, -16.022194f, -53.111488f, -2.714166f, 21.007157f},       // K[3][1]
                            {20.161992f, -64.660372f, 27.855422f, 70.394035f, -48.544758f, -25.644058f},     // K[3][2]
                            {2.089752f, -8.114385f, 4.960993f, 6.819777f, -6.383453f, -4.348208f},           // K[3][3]
                            {5.084977f, 78.126808f, -16.396744f, -70.350085f, 2.850045f, 17.566893f},        // K[3][4]
                            {0.330801f, 3.290680f, 0.122837f, -2.537048f, -0.228374f, -0.228831f},           // K[3][5]
                            {2.023175f, -1.359266f, 32.850888f, -13.368484f, -32.701484f, -19.203713f},      // K[3][6]
                            {-0.036885f, -0.102255f, 1.540480f, -0.642203f, -0.514582f, -0.134881f},         // K[3][7]
                            {72.184449f, -131.450631f, -109.826156f, 25.030999f, 118.460333f, 106.769572f},  // K[3][8]
                            {4.342461f, -4.621033f, -8.708921f, -2.134527f, 7.879481f, 8.282228f}            // K[3][9]
                        },
                },
