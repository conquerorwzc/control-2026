        ...
        {.param =
             {
                 ...
                 .LQR_K_Coefficients =
                     {
                         {-25.040813f, 57.875085f, -16.276416f, -63.988762f, -48.469732f, 102.328237f},   // K[0][0]
                         {-25.717319f, 58.311486f, -9.974749f, -64.405304f, -49.664594f, 92.108786f},     // K[0][1]
                         {-5.280534f, -9.603673f, -77.737695f, 18.723388f, -55.546930f, 126.309480f},     // K[0][2]
                         {-0.786629f, -1.909456f, -18.908361f, 3.813325f, -12.211688f, 29.821832f},       // K[0][3]
                         {-14.612355f, 36.912468f, 55.415043f, -49.897980f, 52.115124f, -51.191081f},     // K[0][4]
                         {-0.031494f, -0.320878f, 1.212701f, -0.566096f, 2.595227f, -1.617871f},          // K[0][5]
                         {-14.357914f, 34.545927f, -130.895982f, -34.212831f, -71.627499f, 240.794144f},  // K[0][6]
                         {-3.203050f, 0.304371f, 4.459682f, -0.680560f, 0.682243f, -3.060284f},           // K[0][7]
                         {-0.521375f, 7.531134f, 205.173608f, -6.022999f, -74.628330f, -175.712132f},     // K[0][8]
                         {-1.926764f, 4.814849f, 20.221614f, -4.387207f, -14.650813f, -11.834552f},       // K[0][9]
                         {-25.040813f, -16.276416f, 57.875085f, 102.328237f, -48.469732f, -63.988762f},   // K[1][0]
                         {-25.717319f, -9.974749f, 58.311486f, 92.108786f, -49.664594f, -64.405304f},     // K[1][1]
                         {5.280534f, 77.737695f, 9.603673f, -126.309480f, 55.546930f, -18.723388f},       // K[1][2]
                         {0.786629f, 18.908361f, 1.909456f, -29.821832f, 12.211688f, -3.813325f},         // K[1][3]
                         {-14.357914f, -130.895982f, 34.545927f, 240.794144f, -71.627499f, -34.212831f},  // K[1][4]
                         {-3.203050f, 4.459682f, 0.304371f, -3.060284f, 0.682243f, -0.680560f},           // K[1][5]
                         {-14.612355f, 55.415043f, 36.912468f, -51.191081f, 52.115124f, -49.897980f},     // K[1][6]
                         {-0.031494f, 1.212701f, -0.320878f, -1.617871f, 2.595227f, -0.566096f},          // K[1][7]
                         {-0.521375f, 205.173608f, 7.531134f, -175.712132f, -74.628330f, -6.022999f},     // K[1][8]
                         {-1.926764f, 20.221614f, 4.814849f, -11.834552f, -14.650813f, -4.387207f},       // K[1][9]
                         {-0.134445f, -10.495123f, 35.477525f, 12.985122f, -1.317664f, -41.751390f},      // K[2][0]
                         {0.262424f, -10.170590f, 33.791343f, 12.988763f, -0.690597f, -39.927476f},       // K[2][1]
                         {-7.090973f, -12.974723f, 22.516384f, 14.529155f, 10.048795f, -16.232517f},      // K[2][2]
                         {-1.256328f, -2.982001f, 4.820773f, 3.103954f, 1.932929f, -2.743548f},           // K[2][3]
                         {1.424282f, 17.299979f, 7.087172f, -13.461676f, -10.059533f, -19.588389f},       // K[2][4]
                         {-0.051069f, 0.908859f, 0.151476f, 0.086953f, 0.116594f, -0.767194f},            // K[2][5]
                         {0.941664f, -14.393357f, 53.742615f, 17.833083f, -2.229507f, -37.562951f},       // K[2][6]
                         {0.184194f, 0.163400f, 2.506919f, -0.205391f, -0.267722f, -1.398395f},           // K[2][7]
                         {14.801546f, -26.732043f, 0.469796f, 25.826955f, 15.417885f, -32.192891f},       // K[2][8]
                         {2.012061f, -4.794923f, 0.613169f, 4.728271f, 3.031691f, -4.605033f},            // K[2][9]
                         {-0.134445f, 35.477525f, -10.495123f, -41.751390f, -1.317664f, 12.985122f},      // K[3][0]
                         {0.262424f, 33.791343f, -10.170590f, -39.927476f, -0.690597f, 12.988763f},       // K[3][1]
                         {7.090973f, -22.516384f, 12.974723f, 16.232517f, -10.048795f, -14.529155f},      // K[3][2]
                         {1.256328f, -4.820773f, 2.982001f, 2.743548f, -1.932929f, -3.103954f},           // K[3][3]
                         {0.941664f, 53.742615f, -14.393357f, -37.562951f, -2.229507f, 17.833083f},       // K[3][4]
                         {0.184194f, 2.506919f, 0.163400f, -1.398395f, -0.267722f, -0.205391f},           // K[3][5]
                         {1.424282f, 7.087172f, 17.299979f, -19.588389f, -10.059533f, -13.461676f},       // K[3][6]
                         {-0.051069f, 0.151476f, 0.908859f, -0.767194f, 0.116594f, 0.086953f},            // K[3][7]
                         {14.801546f, 0.469796f, -26.732043f, -32.192891f, 15.417885f, 25.826955f},       // K[3][8]
                         {2.012061f, 0.613169f, -4.794923f, -4.605033f, 3.031691f, 4.728271f}             // K[3][9]
                     },
             },
