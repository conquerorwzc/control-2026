            ...
            .param =
                {
                    ...
                    .LQR_K_Coefficients =
                        {
                            {-18.872004f, 44.955425f, 10.892542f, -46.277509f, -50.331920f, 43.648606f},    // K[0][0]
                            {-23.599679f, 58.728849f, 16.954413f, -57.896228f, -70.137957f, 48.938609f},    // K[0][1]
                            {-9.511495f, -39.281362f, -84.482983f, 50.836205f, -33.506728f, 156.261020f},   // K[0][2]
                            {-1.117002f, -6.000390f, -17.781930f, 7.503588f, -6.807068f, 30.622067f},       // K[0][3]
                            {-7.133686f, 41.304737f, 52.397735f, -54.617530f, 44.283063f, -78.985745f},     // K[0][4]
                            {-0.052396f, -0.095148f, 0.132556f, 0.507010f, 1.065266f, 0.048176f},           // K[0][5]
                            {-37.440832f, 10.731311f, 4.081957f, -13.108465f, -32.388511f, 57.442669f},     // K[0][6]
                            {-0.991759f, 0.761816f, -0.010217f, -1.275995f, 0.767616f, -0.017964f},         // K[0][7]
                            {11.068148f, -24.643020f, 414.624270f, 12.313635f, -93.458214f, -468.244510f},  // K[0][8]
                            {-0.655343f, 0.373735f, 28.649463f, -0.154234f, -13.394580f, -26.208492f},      // K[0][9]
                            {-18.872004f, 10.892542f, 44.955425f, 43.648606f, -50.331920f, -46.277509f},    // K[1][0]
                            {-23.599679f, 16.954413f, 58.728849f, 48.938609f, -70.137957f, -57.896228f},    // K[1][1]
                            {9.511495f, 84.482983f, 39.281362f, -156.261020f, 33.506728f, -50.836205f},     // K[1][2]
                            {1.117002f, 17.781930f, 6.000390f, -30.622067f, 6.807068f, -7.503588f},         // K[1][3]
                            {-37.440832f, 4.081957f, 10.731311f, 57.442669f, -32.388511f, -13.108465f},     // K[1][4]
                            {-0.991759f, -0.010217f, 0.761816f, -0.017964f, 0.767616f, -1.275995f},         // K[1][5]
                            {-7.133686f, 52.397735f, 41.304737f, -78.985745f, 44.283063f, -54.617530f},     // K[1][6]
                            {-0.052396f, 0.132556f, -0.095148f, 0.048176f, 1.065266f, 0.507010f},           // K[1][7]
                            {11.068148f, 414.624270f, -24.643020f, -468.244510f, -93.458214f, 12.313635f},  // K[1][8]
                            {-0.655343f, 28.649463f, 0.373735f, -26.208492f, -13.394580f, -0.154234f},      // K[1][9]
                            {0.589120f, -10.405188f, 33.233879f, 13.579370f, -3.230079f, -42.503062f},      // K[2][0]
                            {1.097354f, -13.165871f, 38.487213f, 16.508654f, -1.620181f, -50.214172f},      // K[2][1]
                            {-11.015612f, -10.129750f, 42.965980f, 5.803228f, 30.710230f, -48.643593f},     // K[2][2]
                            {-1.653359f, -2.585526f, 7.244957f, 1.844032f, 4.977332f, -6.778654f},          // K[2][3]
                            {0.722125f, 24.789508f, 0.097494f, -12.985567f, -26.754728f, -9.590850f},       // K[2][4]
                            {-0.091536f, 1.337040f, 0.523094f, -0.541325f, 0.011460f, -1.060686f},          // K[2][5]
                            {3.233628f, -5.365184f, 74.664186f, 5.033367f, -2.360903f, -68.482902f},        // K[2][6]
                            {0.029685f, 0.091279f, 2.342539f, -0.043884f, -0.743664f, -0.486126f},          // K[2][7]
                            {33.567882f, -52.613998f, -49.694063f, 56.758528f, 48.185072f, -5.537069f},     // K[2][8]
                            {2.974651f, -6.290328f, -1.749242f, 6.558360f, 4.909600f, -3.911834f},          // K[2][9]
                            {0.589120f, 33.233879f, -10.405188f, -42.503062f, -3.230079f, 13.579370f},      // K[3][0]
                            {1.097354f, 38.487213f, -13.165871f, -50.214172f, -1.620181f, 16.508654f},      // K[3][1]
                            {11.015612f, -42.965980f, 10.129750f, 48.643593f, -30.710230f, -5.803228f},     // K[3][2]
                            {1.653359f, -7.244957f, 2.585526f, 6.778654f, -4.977332f, -1.844032f},          // K[3][3]
                            {3.233628f, 74.664186f, -5.365184f, -68.482902f, -2.360903f, 5.033367f},        // K[3][4]
                            {0.029685f, 2.342539f, 0.091279f, -0.486126f, -0.743664f, -0.043884f},          // K[3][5]
                            {0.722125f, 0.097494f, 24.789508f, -9.590850f, -26.754728f, -12.985567f},       // K[3][6]
                            {-0.091536f, 0.523094f, 1.337040f, -1.060686f, 0.011460f, -0.541325f},          // K[3][7]
                            {33.567882f, -49.694063f, -52.613998f, -5.537069f, 48.185072f, 56.758528f},     // K[3][8]
                            {2.974651f, -1.749242f, -6.290328f, -3.911834f, 4.909600f, 6.558360f}           // K[3][9]
                        },
                },
