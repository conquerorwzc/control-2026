...
set(CHASSIS_TYPE chassis_wheel_legged_sjtu_27)
set(GIMBAL_TYPE gimbal_standard)
set(SHOOT_TYPE shoot_standard)

# 当前 27demo 的 ACE 机构学、VMC、腿长 PID 和唯一六电机输出仲裁。
set(WHEEL_LEGGED_27_CORE_COMPONENT_DIR
        "${CMAKE_SOURCE_DIR}/UserApp/components/chassis/chassis_wheel_legged_double_closed_loop")
set(WHEEL_LEGGED_27_LQR_EXPORT_DIR
...
# add_compile_definitions(USE_OCD_CTRL) #图传链路；当前工程未提供 VT13 驱动，保留为后续接入项。
...
include_sub_directories_recursively(${WHEEL_LEGGED_27_CORE_COMPONENT_DIR})
include_directories(${WHEEL_LEGGED_27_LQR_EXPORT_DIR})
...
file(GLOB ROBOT_SOURCES
        ...
        "${CMAKE_CURRENT_LIST_DIR}/ctrl/*.c"
        "${CMAKE_CURRENT_LIST_DIR}/ui/*.c"
        "${CMAKE_SOURCE_DIR}/UserApp/components/chassis/${CHASSIS_TYPE}/*.c"
        "${WHEEL_LEGGED_27_CORE_COMPONENT_DIR}/*.c"
        "${WHEEL_LEGGED_27_CORE_COMPONENT_DIR}/kinematics/*.c"
        "${WHEEL_LEGGED_27_CORE_COMPONENT_DIR}/transmission/*.c"
