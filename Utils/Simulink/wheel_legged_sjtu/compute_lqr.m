...
% 能用
%             位置     速度      偏航   偏航速   左腿角   左腿速     右腿角   右腿速      俯仰角   俯仰速
lqr_Q = diag([500,    500,      8000,    1,      2000,     20,       2000,     20,       15000,    1]);
% 感觉转向还行？但是位置不稳
% lqr_Q = diag([500,    300,      800,    1,      100,     10,       100,     10,       5000,    1]);
% lqr_Q = diag([500,    700,      1450,    1,      100,     10,       100,     10,       5000,    1]);
% R矩阵: 控制输入权重
